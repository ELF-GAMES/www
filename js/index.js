...
let contract = "0x0284aDE7A01C92Ae11470Ac3B9EC1Da48891A360";
...
async function connectWallet() {
    if (window.ethereum) {
        ...
        if((await new Web3(window.ethereum).eth.net.getId())!=1){
...
async function refreshTotalSupply(){
    ...
    let count = await c.methods.totalSupply().call();
    document.getElementById("minted").innerHTML=count+"/1000";
}
